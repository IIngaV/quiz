let open_modal_buttons = document.querySelectorAll('.open_modal');
...
for (let open_modal of open_modal_buttons) {
    ...
    open_modal.onclick = function () {
        ...
        button_file.addEventListener("change", () => {
            if (button_file.value) {
                ...
                if (acceptedImageTypes.includes(file['type']) && window.innerWidth > 1170) {
